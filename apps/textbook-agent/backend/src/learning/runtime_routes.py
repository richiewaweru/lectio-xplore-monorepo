...
from learning.class_service import (
    accept_class_invite,
...
from learning.runtime_service import (
    complete_instance,
    create_learner,
...
async def api_submit_attempt(
    ...
    if instance.assignment_id:
        ...
        if recipient is not None and recipient.status == "assigned":
            from learning.runtime_service import _utcnow
...
async def api_class_insight(
    ...
    from learning.insight_service import class_overview
