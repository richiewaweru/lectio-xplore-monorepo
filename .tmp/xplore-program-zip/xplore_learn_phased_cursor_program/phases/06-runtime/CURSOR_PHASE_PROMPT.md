# Cursor Master Prompt — Phase 06: Runtime Persistence + LearningInstance Execution

You are implementing **only Phase 06** of the Xplore Learn Expansion program.
...
9. Write the report using `PHASE_REPORT_TEMPLATE.md` to:
   `docs/xplore-program/reports/phase-06/PHASE_REPORT.md`
