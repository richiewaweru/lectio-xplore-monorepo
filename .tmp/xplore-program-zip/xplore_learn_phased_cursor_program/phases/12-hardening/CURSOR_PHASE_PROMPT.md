# Cursor Master Prompt — Phase 12: End-to-End Hardening + Recorded Golden Runs

You are implementing **only Phase 12** of the Xplore Learn Expansion program.
...
9. Write the report using `PHASE_REPORT_TEMPLATE.md` to:
   `docs/xplore-program/reports/phase-12/PHASE_REPORT.md`
10. Update `docs/xplore-program/PROGRAM_STATE.md` only if PASS.
11. Do not add new product features after completion.
