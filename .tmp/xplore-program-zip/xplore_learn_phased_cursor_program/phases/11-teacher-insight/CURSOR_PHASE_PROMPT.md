# Cursor Master Prompt — Phase 11: Teacher Analytics / Insight

You are implementing **only Phase 11** of the Xplore Learn Expansion program.
...
9. Write the report using `PHASE_REPORT_TEMPLATE.md` to:
   `docs/xplore-program/reports/phase-11/PHASE_REPORT.md`
10. Update `docs/xplore-program/PROGRAM_STATE.md` only if PASS.
11. Do not begin Phase 12.
