# Cursor Master Prompt — Phase 09: Assignments + Rolling Distribution

You are implementing **only Phase 09** of the Xplore Learn Expansion program.
...
9. Write the report using `PHASE_REPORT_TEMPLATE.md` to:
   `docs/xplore-program/reports/phase-09/PHASE_REPORT.md`
10. Update `docs/xplore-program/PROGRAM_STATE.md` only if PASS.
11. Do not begin Phase 10.
